...
pub const VkAabbPositionsNV = VkAabbPositionsKHR; // C:\Users\dimko\Software\VulkanSDK-1.3.224.1-Installer\Include/vulkan/vulkan_core.h:11655:35: warning: struct demoted to opaque type - has bitfield
...
pub const VkAccelerationStructureMotionInfoNV = struct_VkAccelerationStructureMotionInfoNV; // C:\Users\dimko\Software\VulkanSDK-1.3.224.1-Installer\Include/vulkan/vulkan_core.h:13544:35: warning: struct demoted to opaque type - has bitfield
...
pub const VkSRTDataNV = struct_VkSRTDataNV; // C:\Users\dimko\Software\VulkanSDK-1.3.224.1-Installer\Include/vulkan/vulkan_core.h:13573:35: warning: struct demoted to opaque type - has bitfield
...
pub extern var vh_new_pipeline_state: u32;
pub extern var vh_instance: VkInstance;
pub extern var vh_surface: VkSurfaceKHR;
pub extern var vh_physical_device: VkPhysicalDevice;
pub extern var vh_logical_device: VkDevice;
pub extern var vh_pipeline_layout: [*c]VkPipelineLayout;
pub extern var vh_swapchain_image_count: u32;
pub extern var vh_clear_colour: VkClearColorValue;
pub extern var vh_shadow_image: VkImage;
pub extern var vh_shadow_image_memory: VkDeviceMemory;
pub extern var vh_shadow_image_view: VkImageView;
pub extern var cmd_buffer_copy_depth_to_shadow: VkCommandBuffer;
pub extern fn vh_copy_depth_to_shadow_image(...) c_int;
pub extern fn vh_wait_gpu_cpu_fence(idx: u32) void;
pub extern fn vh_create_instance(application_name: [*c]const u8, enabled_extension_names: [*c][*c]const u8, enabled_extension_count: usize) c_int;
pub extern fn vh_clear_depth_image(command_buffer: [*c]VkCommandBuffer) c_int;
pub extern fn vh_init(max_frames: u32) c_int;
pub extern fn vh_set_width_height(width: u32, height: u32) c_int;
pub extern fn vh_create_swapchain(...) c_int;
pub extern fn vh_destroy_swapchain() c_int;
pub extern fn vh_create_pipeline(vertex_shader_path: [*c]const u8, fragment_shader_path: [*c]const u8, set_input_state: ?*const fn ([*c]VkPipelineVertexInputStateCreateInfo) callconv(.C) c_int, set_pipeline_layout: ?*const fn ([*c]VkPipelineLayoutCreateInfo) callconv(.C) c_int, index: [*c]u32) c_int;
pub extern fn vh_destroy_pipeline(index: u32) c_int;
pub extern fn vh_begin_draw_command_buffer(command_buffer: [*c]VkCommandBuffer) c_int;
pub extern fn vh_bind_pipeline_to_command_buffer(pipeline_index: u32, command_buffer: [*c]const VkCommandBuffer) c_int;
pub extern fn vh_end_draw_command_buffer(command_buffer: [*c]VkCommandBuffer) c_int;
pub extern fn vh_destroy_draw_command_buffer(command_buffer: [*c]VkCommandBuffer) c_int;
pub extern fn vh_create_sync_objects() c_int;
pub extern fn vh_destroy_sync_objects() c_int;
pub extern fn vh_recreate_pipelines_and_swapchain() c_int;
pub extern fn vh_acquire_next_image(pipeline_index: u32, image_index: [*c]u32, frame_index_out: [*c]u32) c_int;
pub extern fn vh_present_next_image() c_int;
pub extern fn vh_draw(command_buffer: [*c]VkCommandBuffer, only_shadows: c_int) c_int;
pub extern fn vh_create_buffer(buffer: [*c]VkBuffer, buffer_usage_flags: VkBufferUsageFlags, buffer_size: u32, memory: [*c]VkDeviceMemory, memory_property_flags: VkMemoryPropertyFlags) c_int;
pub extern fn vh_destroy_buffer(buffer: VkBuffer, memory: VkDeviceMemory) c_int;
pub extern fn vh_copy_buffer(source: VkBuffer, destination: VkBuffer, size: VkDeviceSize) c_int;
pub extern fn vh_create_image(image: [*c]VkImage, image_width: u32, image_height: u32, image_format: VkFormat, image_tiling: VkImageTiling, image_usage_flags: VkImageUsageFlags, memory: [*c]VkDeviceMemory, memory_property_flags: VkMemoryPropertyFlags) c_int;
pub extern fn vh_destroy_image(image: VkImage, image_memory: VkDeviceMemory) c_int;
pub extern fn vh_transition_image_layout(image: VkImage, format: VkFormat, old_layout: VkImageLayout, new_layout: VkImageLayout, only_depth: c_int) c_int;
pub extern fn vh_copy_buffer_to_image(buffer: VkBuffer, image: VkImage, width: u32, height: u32) c_int;
pub extern fn vh_create_image_view(image_view: [*c]VkImageView, image: VkImage, format: VkFormat, aspect_flags: VkImageAspectFlags) c_int;
pub extern fn vh_create_sampler(sampler: [*c]VkSampler, addressMode: VkSamplerAddressMode) c_int;
pub extern fn vh_create_depth_to_shadow_copy_cmd(...) c_int;
pub extern fn vh_destroy_depth_to_shadow_copy_cmd(...) c_int;
pub extern fn vh_shutdown() c_int;
...
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stddef.h:104:9
pub const __stdint_join3 = @compileError("unable to translate C expr: unexpected token '##'"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stdint.h:245:9
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token '##'"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stdint.h:282:9
pub const __uint_c = @compileError("unable to translate macro: undefined identifier `U`"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stdint.h:284:9
pub const __INTN_MIN = @compileError("unable to translate macro: undefined identifier `INT`"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stdint.h:776:10
pub const __INTN_MAX = @compileError("unable to translate macro: undefined identifier `INT`"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stdint.h:777:10
pub const __UINTN_MAX = @compileError("unable to translate macro: undefined identifier `UINT`"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stdint.h:778:9
pub const __INTN_C = @compileError("unable to translate macro: undefined identifier `INT`"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stdint.h:779:10
pub const __UINTN_C = @compileError("unable to translate macro: undefined identifier `UINT`"); // C:\Users\dimko\Software\zig-windows-x86_64-0.10.1\lib\include/stdint.h:780:9
pub const VK_DEFINE_HANDLE = @compileError("unable to translate macro: undefined identifier `_T`"); // C:\Users\dimko\Software\VulkanSDK-1.3.224.1-Installer\Include/vulkan/vulkan_core.h:25:9
pub const VK_DEFINE_NON_DISPATCHABLE_HANDLE = @compileError("unable to translate macro: undefined identifier `_T`"); // C:\Users\dimko\Software\VulkanSDK-1.3.224.1-Installer\Include/vulkan/vulkan_core.h:55:17
...
pub const VULKAN_HELPER_NO_NATIVE = @as(c_int, 1);
pub const VULKAN_HELPER_H = "";
